...
const postReqValidator = require('../../../app/validators/postUserReqValidator');
const config = require('../../../config/config');
const expect = require('chai').expect;
const _ = require('lodash');

describe('test/unit/validators/postUserReqValidator check', function() { // eslint-disable-line
  let req = {};
  beforeEach(() => {
    req = {
      body: {
...
describe('test/unit/validators/postUserReqValidator sanitize', function() { // eslint-disable-line
  let req = {};
  beforeEach(() => {
    req = {
      body: {
